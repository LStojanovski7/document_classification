...
def custom_get_words(doc, words_to_ignore=words_to_ignore):
    words = set()
    for word in re.split('\\W+', doc):
...
if __name__ == "__main__":
    ...
    cl2 = NaiveBayes(custom_get_words)
    ...
    cls1 = cl1.classify_document(recenica)
    cls2 = cl2.classify_document(recenica)
